...
Функция: Выбор торговых сетей
  ...
  Сценарий: Раскрытие фильтра
    ...
    # стоит убрать средний размер скидки, товаров на акции, эти данные изменчивы, однако есть шанс иметь тестовые данные на dev сервере
  ...
  Сценарий: Исключение всех торговых сетей из выбора
    ...
    Если я нажимаю кнопку "Подвердить" в фильтре "Тороговые сети"
    То на панели "Список акционных товаров" не должно остаться ни одной карточки
  ...
  Сценарий: Выбор нескольких торговых сетей из списка
    ...
    То в фильтре "Торговые сети" должны отобразиться следующие статусы:
      ...
      | Рублёвский    | Не выбрана  |
      | Соседи        | Выбрана     |
    #опять же, возможно здесь возможно иметь какие-то тестовые данные
