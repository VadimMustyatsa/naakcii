...
Функция: Добавление товаров в список покупок
  ...
  Сценарий: раскрытие карточки товара на панели "Список покупок"
    ...
    И на карточке "Ананас, коста-рико, 1кг" на панели "Список покупок" должна отобразиться следующая информация:
      | информация                    |           |
  ...
  Сценарий: добавление комментария в карточку товара на панели "Список покупок"
    ...
    То на карточке "Йогурт Савушкин 2%, 120г" на панели "Список покупок" должна отобразиться следующая информация:
      | информация                            |           |
      | Йогурт Савушкин 2%, 120г              |           |
      | Старая цена: 0.49 руб.                |           |
      | Новая цена: 0.39 руб.                 |           |
