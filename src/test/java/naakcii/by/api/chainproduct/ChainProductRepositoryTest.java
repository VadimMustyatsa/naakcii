...
public class ChainProductRepositoryTest {
	...
	public void setUp() {
		...
		Subcategory firstSubcategory = new Subcategory("First subcategory", true, category);
		Subcategory secondSubcategory = new Subcategory("Second subcategory", true, category);
		Subcategory thirdSubcategory = new Subcategory("Third subcategory", true, category);
		Subcategory fourthSubcategory = new Subcategory("Fourth subcategory", true, category);
		...
		Chain fourthChain = new Chain("Fourth chain", "Fourth chain synonym","Fourth chain link", true);
		ChainProductType firstChainProductType = new ChainProductType("First ChainProduct type", "Synonym");
		ChainProductType secondChainProductType = new ChainProductType("Second ChainProduct type", "Synonym");
		...
		Product firstProduct = new Product("10000000000000", "First product", firstUnitOfMeasure, true, firstSubcategory);
		Product secondProduct = new Product("20000000000000", "Second product", firstUnitOfMeasure, true, firstSubcategory);
		Product thirdProduct = new Product("30000000000000", "Third product", firstUnitOfMeasure, true, firstSubcategory);
		Product fourthProduct = new Product("40000000000000", "Fourth product", firstUnitOfMeasure, true, secondSubcategory);
		Product fifthProduct = new Product("50000000000000", "Fifth product", firstUnitOfMeasure, true, secondSubcategory);
		Product sixthProduct = new Product("60000000000000", "Sixth product", secondUnitOfMeasure, true, thirdSubcategory);
		Product seventhProduct = new Product("70000000000000", "Seventh product", secondUnitOfMeasure, true, thirdSubcategory);
		Product eighthProduct = new Product("80000000000000", "Eighth product", secondUnitOfMeasure, true, fourthSubcategory);
		Product ninthProduct = new Product("90000000000000", "Ninth product", secondUnitOfMeasure, false, firstSubcategory);
		Product tenthProduct = new Product("10000000000000", "Tenth product", secondUnitOfMeasure, false, secondSubcategory);
