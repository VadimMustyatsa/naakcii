...
public class ChainProductTest {
	...
	public ChainProductType getActionType() {
		return new ChainProductType("Action type name");
	}
	...
	public void test_action_base_price_has_too_many_fraction_digits() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("5.25"), getActionType(), getStartDate(), getEndDate());
	...
	public void test_action_discount_price_is_null() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), null, getActionType(), getStartDate(), getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_discount_price_has_too_many_fraction_digits() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("5.575"), getActionType(), getStartDate(), getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_discount_price_is_too_high() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("30.50"), getActionType(), getStartDate(), getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_discount_price_is_too_low() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("0.05"), getActionType(), getStartDate(), getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_has_not_chain() {
		ChainProduct action = new ChainProduct();
	...
	public void test_action_type_is_null() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("5.25"), null, getStartDate(), getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_type_is_invalid() {
		...
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("5.25"), actionType, getStartDate(), getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_start_date_is_null() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("15.25"), getActionType(), null, getEndDate());
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_end_date_is_null() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("15.25"), getActionType(), getStartDate(), null);
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_end_date_is_in_the_past() {
		Calendar endDate = Calendar.getInstance();
		endDate.add(Calendar.MONTH, -1);
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("5.25"), getActionType(), getStartDate(), endDate);
		Set<ConstraintViolation<ChainProduct>> constraintViolations = validator.validate(action);
	...
	public void test_action_is_valid() {
		ChainProduct action = new ChainProduct(new Product(), new Chain(), new BigDecimal("15.25"), getActionType(), getStartDate(), getEndDate());
