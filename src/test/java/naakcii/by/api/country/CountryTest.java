...
public class CountryTest {
	...
	public void test_country_name_is_too_short() {
        ...
        assertEquals("Name of the country 'Ar' must be between '3' and '50' characters long.", constraintViolations.iterator().next().getMessage());
	}
	...
	public void test_country_AlphaCode2_is_null() {
        ...
        assertEquals("AlphaCode2 of the country mustn't be blank.", constraintViolations.iterator().next().getMessage());
	}
	...
	public void test_country_AlphaCode2_is_too_long() {
        ...
        assertEquals("AlphaCode2 of the country 'BLR' must be '2' characters long.", constraintViolations.iterator().next().getMessage());
	}
	...
	public void test_country_AlphaCode2_is_too_short() {
        ...
        assertEquals("AlphaCode2 of the country 'B' must be '2' characters long.", constraintViolations.iterator().next().getMessage());
	}
	...
	public void test_country_AlphaCode3_is_null() {
        ...
        assertEquals("AlphaCode3 of the country mustn't be blank.", constraintViolations.iterator().next().getMessage());
	}
	...
	public void test_country_AlphaCode3_is_too_long() {
        ...
        assertEquals("AlphaCode3 of the country 'RBLR' must be '3' characters long.", constraintViolations.iterator().next().getMessage());
	}
	...
	public void test_country_AlphaCode3_is_too_short() {
        ...
        assertEquals("AlphaCode3 of the country 'BR' must be '3' characters long.", constraintViolations.iterator().next().getMessage());
	}
